...
async function getRelatedVideo(setClist,cid){
    try{
      ...
      const d = await fetch(`https://cors-anywhere.herokuapp.com/https://youtube.googleapis.com/youtube/v3/search?part=snippet&videoDuration=medium&maxResults=25&type=video&channelId=${cid}&key=${process.env.YOUTUBE_API_KEY}`);                         //->trial 2
